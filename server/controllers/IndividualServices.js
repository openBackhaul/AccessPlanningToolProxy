 ...
 ****************************************************************************************/
  ...
  ****************************************************************************************/
  ...
  let responseHeader = {};
  responseHeader.lifeCycleState = lifeCycleState;
  await IndividualServices.provideConfigurationForLiveNetView(body, user, originator, xCorrelator, traceIndicator, customerJourney)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
    })
...
module.exports.updateAptClient = async function updateAptClient(req, res, next, body, user, originator, xCorrelator, traceIndicator, customerJourney) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.NO_CONTENT;
  let responseBodyToDocument = {};
  /****************************************************************************************
...
//  let originator = await httpServerInterface.getApplicationNameAsync();
  ...
  ****************************************************************************************/
  ...
  let responseHeader = {};
  responseHeader.lifeCycleState = lifeCycleState;
  await IndividualServices.updateAptClient(body, user, originator, xCorrelator, traceIndicator, customerJourney)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
    })
