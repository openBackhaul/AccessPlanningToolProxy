...
exports.dispatchEventWithBasicAuth = async function(operationClientUuid, httpRequestBody, user, xCorrelator, traceIndicator, customerJourney, httpMethod, basicAuth,params ) {
    let responseData = {};
    let operationKey = await OperationClientInterface.getOperationKeyAsync(
        operationClientUuid);
    let operationName = await OperationClientInterface.getOperationNameAsync(
    ...
    headers = OnfAttributeFormatter.modifyJsonObjectKeysToKebabCase(headers);
